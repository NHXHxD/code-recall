...
import { Sparkles, Loader2, BarChart3, Brain, FileText } from 'lucide-react';
          ...
          <Card className="border-[var(--border)] shadow-lg">
            <CardContent className="p-8">
              ...
              <Button
                ...
                disabled={isLoading}
                variant="outline"
                className="w-full gap-3 border-[var(--border)] bg-[var(--card)] py-6 text-[var(--foreground)] hover:bg-[var(--muted)]"
              >
                {isLoading ? (
